...
include Validated_string.Make (struct
    let module_name = "Dunolint.Dune_project.Name"
...
module Predicate = struct
  ...
  let __t_of_sexp__ =
    (let error_source__030_ = "lib/dunolint/src/dune_project0/name.ml.Predicate.t" in
     function
  ...
  let t_of_sexp =
    (let error_source__038_ = "lib/dunolint/src/dune_project0/name.ml.Predicate.t" in
     fun sexp__037_ ->
