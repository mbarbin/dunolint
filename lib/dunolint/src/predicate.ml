  ...
  (let error_source__037_ = "lib/dunolint/src/predicate.ml.t" in
   ...
   | Sexplib0.Sexp.Atom atom__030_ as _sexp__032_ ->
     (match atom__030_ with
      | "path" -> Sexplib0.Sexp_conv_error.ptag_takes_args error_source__037_ _sexp__032_
      | "dune" -> Sexplib0.Sexp_conv_error.ptag_takes_args error_source__037_ _sexp__032_
      | "dune_project" ->
        Sexplib0.Sexp_conv_error.ptag_takes_args error_source__037_ _sexp__032_
      | _ -> Sexplib0.Sexp_conv_error.no_variant_match ())
   | Sexplib0.Sexp.List (Sexplib0.Sexp.Atom atom__030_ :: sexp_args__033_) as _sexp__032_
     ->
     (match atom__030_ with
      | "path" as _tag__041_ ->
      ...
      | "dune_project" as _tag__034_ ->
        (match sexp_args__033_ with
         | arg0__035_ :: [] ->
           let res0__036_ = Blang.t_of_sexp Dune_project.Predicate.t_of_sexp arg0__035_ in
