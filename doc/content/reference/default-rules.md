...
These paths are skipped regardless of whether you have a custom configuration file. You can add your own skip paths using the `(skip_paths ...)` construct in your configuration file (see [Config Language Reference](@/reference/config/_index.md)).
...
- [Config Language Reference](@/reference/config/_index.md) - Learn how to write custom rules
- [Canonical Ordering Philosophy](@/explanation/canonical-ordering.md) - Understand the reasoning behind these defaults
- [Quick Start Tutorial](@/tutorials/quick-start/index.md) - Get started with custom configurations
