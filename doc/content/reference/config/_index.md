+++
title = "Config Language Reference"
weight = 3
sort_by = "weight"
+++
...
- [dune](@/reference/config/dune.md)
- [dune-project](@/reference/config/dune-project.md)
- [dune-workspace](@/reference/config/dune-workspace.md)
- [dunolint](@/reference/config/dunolint.md)
