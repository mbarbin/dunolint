...
This pattern gives you the best of both worlds: automated sorting within logical groups, plus forced documentation of why the grouping exists. See [Comments in Libraries](@/explanation/linting-equilibrium/comments-in-libraries.md) for detailed examples.
