...
If you are looking for the config language reference instead, head over [here](@/reference/config/_index.md).
...
You can find the exact list of handled fragments in the [config language reference](@/reference/config/_index.md).
