...
- [Config Reference](@/reference/config/_index.md) - Complete config file syntax and options
- [Workspace Root](@/explanation/workspace-root.md) - How dunolint finds the workspace root
