...
- dunolint installed (see [installation guide](@/guides/installation.md))
...
- [Configuration Language](@/reference/config/_index.md) - Write custom rules
- [Quick Start Tutorial](@/tutorials/quick-start/index.md) - Create your first configuration
