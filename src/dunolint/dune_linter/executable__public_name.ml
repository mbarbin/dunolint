...
type t = { mutable public_name : Dune.Executable.Public_name.t }

let sexp_of_t { public_name } : Sexp.t =
  List [ List [ Atom "public_name"; Dune.Executable.Public_name.sexp_of_t public_name ] ]
;;
